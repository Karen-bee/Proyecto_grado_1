            ...
            <div class="formulario">
                <form id="formEmail" method="post" action="Login/envio_correo.php">
                    ...
                    <div class="mb-3">
                        ...
                        <a class="enlace1" href="/Literagiando/Views/Home"><strong>Volver a inicio de sesión</strong></a>
                    </div>
                    ...
                    <a class="enlace2" href="/Literagiando/Views/Login/register_user.php" onclick="abrirPopup">Registrate aqui.</a>
                </form>
            </div>
        </div>
    </div>
