...
require_once('../../App/Models/Coneccion.php');

// FPDF / PDF_MC_Table
require('../../literagiando59/recursos/libraries/fpdf/pdf_mc_table.php');
...
$pdf->Image( '../../literagiando59/recursos/img/logos/logotipo_2.png', 15, 25);
$pdf->Ln(14);
...
$pdf->Cell(31, 8, utf8_decode('RANGO'), 1, 0, 'C');
$pdf->Cell(31, 8, utf8_decode('IDENTIFICACIÓN'), 1, 0, 'C');
$pdf->Cell(40, 8, utf8_decode('NOMBRE COMPLETO'), 1, 0, 'C');
...
$pdf->SetWidths(array(17, 31, 31, 40, 20, 22, 60, 35, 18));
...
foreach ($resultado as $fila) {
	$pdf->Row(array(utf8_decode($fila['id_usuario']),utf8_decode($fila['nombre_rol']),utf8_decode($fila['identificacion']),utf8_decode($fila['nombre_completo']),utf8_decode($fila['sexo']),utf8_decode($fila['telefono']),utf8_decode($fila['correo']),utf8_decode($fila['usuario']),utf8_decode($fila['acceso']),));
}
