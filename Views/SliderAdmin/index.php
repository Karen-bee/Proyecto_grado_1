            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="/Literagiando/Routes/SliderRouter.php?accion=eliminar&idsliders=<?php echo htmlspecialchars($slider['id']); ?>" class="btn btn-outline-danger btn-sm"><i class='bx bx-trash'></i></a>
                </td>
              </tr>
              <?php } ?>
