...
<html lang="es">
	...
	<head>
		...
		<!-- .Titulo -->
		<title>Editar usuarios - <?php echo base_titulo_2; ?></title>
...
<?php const base_tabla_titulo = 'Editar usuarios'; ?>
												...
												<form method="post" action="editar_usuarios.php?id=<?php echo $fila['id_usuario']; ?>" enctype="multipart/form-data">
													<div class="login-form mb-10">
														<h2 class="login-title-1 mb-2">
															<center>
																Formulario para editar usuarios registrados.
															</center>
														</h2>
														<div class="row">
															<div><hr /></div>
	...
	echo '
								<script>
									Swal.fire({
										...
										icon: "success",
										html: "Use el botón a continuación para volver al listado de usuarios registrados.",
										allowOutsideClick: false,
										showCloseButton: false,
										showCancelButton: false,
										focusConfirm: false,
