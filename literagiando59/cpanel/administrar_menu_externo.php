...
<html lang="es">
	...
	<head>
		...
		<!-- .Titulo -->
		<title>Menú externo - <?php echo base_titulo_2; ?></title>
...
<?php const base_tabla_titulo = 'Menú externo'; ?>
									...
									<div class="containerr">
										<div class="roww">
											<div class="col-lg-11 pt-5" style="margin: 0 auto;">
												<form method="post" action="administrar_menu_externo.php">
													<div class="login-form mb-10">
														<h2 class="login-title-1 mb-2">
															<center>
																Caja de texto para editar el menú externo.
															</center>
														</h2>
														<div class="row">
															<div><hr /></div>
															<div class="scrollspy-examplee position-relative mt-0 overflow-auto">
																<textarea
																	...
																	rows="15"
																	style="width: 2000px;"
																><?php $contenidoActual = file_get_contents('../menu.php'); echo htmlspecialchars($contenidoActual); ?></textarea>
															</div>
															<div><hr /></div>
														</div>
														<center>
	...
	echo '
								<script>
									Swal.fire({
										...
										window.location="administrar_menu_externo.php";
									});
								</script>';
	}
