...
<html lang="es">
	...
	<head>
		...
		<!-- .Titulo -->
		<title>Footer externo - <?php echo base_titulo_2; ?></title>
...
<?php const base_tabla_titulo = 'Footer externo'; ?>
									...
									<div class="containerr">
										<div class="roww">
											<div class="col-lg-11 pt-5" style="margin: 0 auto;">
												<form method="post" action="administrar_footer_externo.php">
													<div class="login-form mb-10">
														<h2 class="login-title-1 mb-2">
															<center>
																Caja de texto para editar el footer externo.
															</center>
														</h2>
														<div class="row">
															<div><hr /></div>
															<div class="scrollspy-examplee position-relative mt-0 overflow-auto">
																<textarea
																	...
																	rows="15"
																	style="width: 2000px;"
																><?php $contenidoActual = file_get_contents('../final.php'); echo htmlspecialchars($contenidoActual); ?></textarea>
															</div>
															<div><hr /></div>
														</div>
														<center>
	...
	echo '
								<script>
									Swal.fire({
										...
										window.location="administrar_footer_externo.php";
									});
								</script>';
	}
