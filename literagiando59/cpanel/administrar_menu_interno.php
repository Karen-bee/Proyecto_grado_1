...
<html lang="es">
	...
	<head>
		...
		<!-- .Titulo -->
		<title>Menú interno - <?php echo base_titulo_2; ?></title>
...
<?php const base_tabla_titulo = 'Menú interno'; ?>
									...
									<div class="containerr">
										<div class="roww">
											<div class="col-lg-11 pt-5" style="margin: 0 auto;">
												<form method="post" action="administrar_menu_interno.php">
													<div class="login-form mb-10">
														<h2 class="login-title-1 mb-2">
															<center>
																Caja de texto para editar el menú interno.
															</center>
														</h2>
														<div class="row">
															<div><hr /></div>
															<div class="scrollspy-examplee position-relative mt-0 overflow-auto">
																<textarea
																	...
																	rows="15"
																	style="width: 2000px;"
																><?php $contenidoActual = file_get_contents('../includes/global_menu.php'); echo htmlspecialchars($contenidoActual); ?></textarea>
															</div>
															<div><hr /></div>
														</div>
														<center>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
		...
		$archivo = '../includes/global_menu.php';
	...
	echo '
								<script>
									Swal.fire({
										...
										window.location="administrar_menu_interno.php";
									});
								</script>';
	}
